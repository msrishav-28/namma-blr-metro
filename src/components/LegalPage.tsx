...
const supportEmail = 'msrishav28@gmail.com';
    ...
    return (
        <>
            <header className="grid gap-3">
                <p className="text-xs font-semibold uppercase text-[#009b50] dark:text-emerald-400">Namma Metro Route Planner</p>
            ...
            <LegalSection title="Overview">
                <p>This Privacy Policy describes our policies and procedures on the collection, use, and disclosure of your information when you use Namma Metro Route Planner.</p>
    ...
    return (
        <>
            ...
            <LegalSection title="Acceptance">
                <p>By accessing or using Namma Metro Route Planner, you agree to these Terms and Conditions. If you do not agree, please do not use the service.</p>
            </LegalSection>

            <LegalSection title="Service">
                <p>Namma Metro Route Planner is an independent route planning tool for Namma Metro journeys. It provides map, route, fare, travel time, stop, and interchange information for general guidance.</p>
                <p>This service is not affiliated with, endorsed by, or operated by Namma Metro Rail Corporation or any government transport authority.</p>
            </LegalSection>
